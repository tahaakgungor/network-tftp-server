...
var IncomingRequest = module.exports = function (args){
	...
	let binded = false
	while(!binded){
		let port = this._globalOptions.singlePort
		? this._globalOptions.port
		: this._globalOptions.portRange
		? getRandomInt(this._globalOptions.portRange.start, this._globalOptions.portRange.end)
		: 0;
		try {
